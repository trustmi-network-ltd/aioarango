...
from aioarango.database import AsyncDatabase, StandardDatabase
...
from aioarango.job import AsyncJob
...
async def test_async_wrapper_attributes(db: StandardDatabase, col: Collection, username):
...
async def test_async_execute_without_result(db: StandardDatabase, col: Collection, docs):
...
async def test_async_execute_error_in_result(db: StandardDatabase, col: Collection, docs):
...
async def test_async_clear_jobs(db: StandardDatabase, bad_db: StandardDatabase, col: Collection, docs):
    async_db = db.begin_async_execution(return_result=True)
    async_col = async_db.collection(col.name)
